...
rm -f /usr/local/bin/3mf-merge /usr/local/bin/3mf-inspect-plates /usr/local/bin/3mf-review-duplicates /usr/local/bin/3mf-deduplicate-ui /usr/local/bin/3mf-validate-project
